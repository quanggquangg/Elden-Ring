...
const SHELL = ['./', 'index.html', 'manifest.webmanifest', 'icons/icon-192.png', 'icons/icon-512.png', 'icons/apple-touch-icon.png', 'icons/favicon-64.png',
  ...
  'src/enemies.js', 'src/bosses.js', 'src/content.js', 'src/systems.js', 'src/render.js', 'src/fx.js', 'src/spirits.js', 'src/hud.js', 'src/bestiary.js', 'src/settings.js', 'src/leaderboard.js'];
